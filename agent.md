...
- `Apply.reg` disables the CDP drag tray through `HKCU\Software\Microsoft\Windows\CurrentVersion\CDP\DragTrayEnabled`; `Revert.reg` should carry the inverse value.
